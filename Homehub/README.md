Вот готовый, красиво оформленный файл `README.md`, основанный на предоставленных вами инструкциях. Я добавил структуру, подсветку синтаксиса и четкое разделение шагов для удобства чтения.
